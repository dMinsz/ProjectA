...
public class DrawSkillRange : MonoBehaviour
{
    ...
    public void Draw()
    {
        ...
        cube.transform.localScale = new Vector3(thickness, 0.1f, attacker.skill.rangeAmount * -2);
        cube2.transform.localScale = new Vector3(thickness, 0.1f, attacker.skill.rangeAmount * -2);
